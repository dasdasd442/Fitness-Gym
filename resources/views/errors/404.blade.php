...
<head>
    ...
    <title>California Fitness Gym | 404</title>
    <style>
        ...
        .btn.green {
            border: 4px solid rgb(55, 157, 175);
            color: var(--blue);
        }
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 align-self-center">
              <img src="{{ asset('images/404.gif') }}" style="float: left; margin-right: 5%; width: 50%;" />
                <g>
                  <defs>
            ...
            {{-- <button class="btn green" onclick="window.location.href='{{ route('mainpage-index') }}'">HOME</button> --}}
            </div>
          </div>
        </div>
      </main>
